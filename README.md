...
- 🤖 Built and deployed **AI-powered apps** using ChatGPT, Claude & Gemini APIs
- 📦 Delivered **4 end-to-end SaaS platforms** from zero to production
- 🏗️ Currently building **people.samyama.work** — an internal HR & productivity platform
- 🎓 B.Tech in **AI & Machine Learning** — CMR Technical Campus, Hyderabad
- 💡 Passionate about combining **AI + full stack** to ship real products fast
...
|---|---|---|
| [people.samyama.work](https://people.samyama.work) | Internal HR tool — attendance, leave, punch in/out, food management, AI training | React.js, Supabase, PostgreSQL, LLM APIs |
| [samyama.ai](https://samyama.ai) | AI chatbot deployed across 4 company websites with dynamic LLM routing | ChatGPT API, Claude API, Gemini API |
...
|---|---|---|---|
| Employee Productivity Platform | 5-module HR tool with AI-powered quiz & training system for 50+ users | React.js, Supabase, PostgreSQL, Edge Functions | [people.samyama.work](https://people.samyama.work) |
| AI Chatbot Platform | Multi-LLM chatbot with prompt engineering & real-time response across 4 sites | ChatGPT, Claude, Gemini APIs | [samyama.ai](https://samyama.ai) |
| samyama.finance | Finance platform with RBAC, auth, automated workflows | React.js, Supabase, PostgreSQL | [samyama.finance](https://samyama.finance) |
| samyama.care | Healthcare platform with CMS, career forms, email automation | Next.js, Supabase, Headless CMS | [samyama.care](https://samyama.care) |
| samyama.blog | Blog platform with dynamic content management | Next.js, Headless CMS | [samyama.blog](https://samyama.blog) |
...
![ChatGPT](https://img.shields.io/badge/ChatGPT_API-74aa9c?style=flat&logo=openai&logoColor=white)
...
![Prompt Engineering](https://img.shields.io/badge/Prompt_Engineering-FF6B6B?style=flat&logo=openai&logoColor=white)
...
![MediaPipe](https://img.shields.io/badge/MediaPipe-00BCD4?style=flat&logo=google&logoColor=white)
![YOLO](https://img.shields.io/badge/YOLO-00FFFF?style=flat&logo=yolo&logoColor=black)
![MLflow](https://img.shields.io/badge/MLflow-0194E2?style=flat&logo=mlflow&logoColor=white)
![Tesseract OCR](https://img.shields.io/badge/Tesseract_OCR-4CAF50?style=flat&logo=google&logoColor=white)
...
| Achievement | Details |
|---|---|
| 4 Production Platforms | Delivered samyama.ai, samyama.finance, samyama.blog, samyama.care end-to-end |
| AI Integration | Built & deployed LLM chatbots using ChatGPT, Claude & Gemini in production |
| 50+ Users Served | Internal HR platform actively used by 50+ employees daily |
| Full Ownership | Owned schema design, auth, RBAC, backend, frontend & deployment solo |
| 5 HR Modules | Attendance, leave, punch in/out, food management, AI training — all shipped |
...
```
Full Stack SaaS       ████████████████████  end-to-end product delivery
AI / LLM Integration  ██████████████████░░  ChatGPT, Claude, Gemini APIs
Backend Systems       ███████████████░░░░░  Supabase, PostgreSQL, Edge Functions
Frontend Development  ██████████████░░░░░░  React, Next.js, Tailwind CSS
Workflow Automation   ████████████░░░░░░░░  background jobs, email, approvals
ML & Computer Vision  ██████████░░░░░░░░░░  PyTorch, OpenCV, YOLO, MediaPipe
```
